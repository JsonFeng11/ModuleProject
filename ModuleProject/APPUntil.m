...
+ (NSString *)deviceID {
    NSString * idfa  = [self loadItem:@"zxdeviceId"];
    ...
    if (idfa && [idfa isKindOfClass:[NSString class]] && idfa.length) {
        ...
        if ([ASIdentifierManager sharedManager].advertisingTrackingEnabled)
        {
            ...
            [self saveItem:@"zxdeviceId" data:idfa];
            return idfa;
        }
        else {//如果取不到,就生成UUID,当成IDFA
...
+(NSString *)getAvailableMemorySize {
    ...
    return [NSString stringWithFormat:@"%lu", ((vm_page_size * vmStats.free_count + vm_page_size * vmStats.inactive_count))];
}
